...
class Helmholtz2D_PINN:
    ...
    def __init__(self, model_type, layers, ics_sampler, bcs_sampler, res_sampler, operator, lam):
        ...
        self.optimizer3 = torch.optim.Adam( [self.lamu], lr=0.1, maximize=True)
    ...
    def AW_loss_fun(self, loss_bcs, loss_res):
        loss = self.lamu * loss_bcs + self.lamr * loss_res
        return loss
